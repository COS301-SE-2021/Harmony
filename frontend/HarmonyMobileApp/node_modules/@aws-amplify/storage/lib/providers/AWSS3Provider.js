...
var AWSS3Provider = /** @class */ (function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        if (!credentialsOK) {
                            return [2 /*return*/, Promise.reject(new Error(StorageErrorStrings_1.StorageErrorStrings.NO_CREDENTIALS))];
                        }
    ...
    AWSS3Provider.prototype.get = function (key, config) {
        return __awaiter(this, void 0, void 0, function () {
            var credentialsOK, opt, bucket, download, cacheControl, contentDisposition, contentEncoding, contentLanguage, contentType, expires, track, prefix, final_key, s3, params, getObjectCommand, response, error_2, signer, request, url, _a, error_3;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (!credentialsOK) {
                            return [2 /*return*/, Promise.reject(StorageErrorStrings_1.StorageErrorStrings.NO_CREDENTIALS)];
                        }
                        opt = Object.assign({}, this._config, config);
