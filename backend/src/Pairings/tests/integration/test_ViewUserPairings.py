...
def test_view_userpairings_with_valid_data_from_db(fixture_event,benchmark):
...
def test_view_userpairings_with_wrong_mealtag_data(incorrect_meal_tag,benchmark):
...
def test_view_userpairings_with_wrong_foodtag_data(incorrect_food_tag,benchmark):
...
def test_view_userpairings_with_wrong_drinktag_data(incorrect_drink_tag,benchmark):
...
def test_view_userpairings_with_wrong_sort_type(incorrect_drink_tag,benchmark):
    data = ViewUserPairings.view_user_pairings(incorrect_drink_tag, "")
    print(data)
    assert data["StatusCode"] == 204
    assert "Data" in data
